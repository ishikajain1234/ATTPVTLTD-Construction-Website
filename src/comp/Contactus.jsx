...
const Contactus = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-500 via-blue-700 to-gray-900 text-white py-12 px-6">
      <div className="w-full max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-7 bg-gradient-to-b from-gray-800 to-gray-900 rounded-lg shadow-lg p-8">
          <h2 className="text-4xl font-bold text-yellow-300 mb-6">Get in Touch</h2>
        ...
        <div className="md:col-span-5 bg-gradient-to-b from-gray-900 to-gray-800 rounded-lg shadow-lg p-8">
          <h2 className="text-4xl font-bold text-yellow-300 mb-6">Company Details</h2>
          <ul className="space-y-4 text-gray-300">
            <li className="flex items-center gap-2">
              <span className="font-bold text-yellow-400">Company Name:</span> Civil-Site Co.
            </li>
            <li className="flex items-center gap-2">
              <span className="font-bold text-yellow-400">Phone:</span> +1 (123) 456-7890
            </li>
            <li className="flex items-center gap-2">
              <span className="font-bold text-yellow-400">Email:</span> contact@civilsite.com
            </li>
            <li className="flex items-center gap-2">
              <span className="font-bold text-yellow-400">Address:</span> 123 Main Street, Suite 100, Cityville, State, Country
            </li>
            <li className="flex items-center gap-2">
              <span className="font-bold text-yellow-400">Business Hours:</span> Mon-Fri, 9:00 AM - 5:00 PM
            </li>
          </ul>
        </div>
      </div>
